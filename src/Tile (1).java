...
public class Tile extends JPanel{
	...
	private HashMap<Integer, Boolean> possibles = new HashMap<>();
	...
	public boolean isPossible(int number){
		return (possibles.get(number) != null);
	}
	...
	private void drawPossible(Graphics g){
		...
		for (int i=0; i<P.N; i++){
			if (possibles.get(i+1)!=null && val == 0)
